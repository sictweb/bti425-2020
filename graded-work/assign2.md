...
> Review the embedded subdocument coverage in the [introduction](/bti425-2020/notes/data-assoc-intro) note and in the [how-to](/bti425-2020/notes/data-assoc-subdocs-how-to) note. 
...
> Review the document reference coverage in the [introduction](/bti425-2020/notes/data-assoc-intro) note and in the [how-to](/bti425-2020/notes/data-assoc-doc-ref-how-to) note. 
...
> [Web API CRUD - "get some" technique](/bti425-2020/notes/web-api-crud-get-some)
...
> [Web API - "command" technique](/bti425-2020/notes/web-api-commands)
...
Also, please remember the other [debug strategies](/bti425-2020/notes/angular-debug-intro) that you have been exposed to. 
...
[Deploy Angular app to Heroku](/bti425-2020/notes/angular-heroku-deploy)
...
Somewhere in the user interface (in an existing component or in a dedicated component), search (for an English term) should be supported. To learn one approach, read the [Angular app "search" UI and UX](/bti425-2020/notes/angular-search-ui) document.
...
* [Angular Forms Data Models](/bti425-2020/notes/angular-forms-data)

* [JavaScript Spread and Object Mapping](/bti425-2020/notes/js-spread-object-mapping)
