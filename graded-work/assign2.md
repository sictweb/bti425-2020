...
The database will include at these two collections:
* terms in English 
  * embedded subdocument collection, definitions in English
* terms in other languages 
  * embedded subdocument collection, definitions in other languages
