  ...
  render() {
    return (
      <div className="container">
        ...
        <hr />
        <footer>
          <p>&copy; 2020, personal or organization name</p>
        </footer>
      </div>
    );
  }
      ...
      <div className="panel-body">
        <div className="row">
          <div className="col-md-8">
            <p>The horse (Equus ferus caballus)<sup>[2][3]</sup> is one of two extant subspecies of Equus ferus. It is an odd-toed ungulate mammal belonging to the taxonomic family Equidae. </p>
  ...
  return (
    <div className="lizard panel panel-default" id="lizard">
      ...
      <div className="panel-body">
        <div className="row">
          <div className="col-md-8">
            <p>Lizards are a widespread group of squamate reptiles, with over 6,000 species<sup>[1]</sup>, ranging across all continents except Antarctica, as well as most oceanic island chains. The group is paraphyletic as it excludes the snakes and Amphisbaenia which are also squamates. Lizards range in size from chameleons and geckos a few centimeters long to the 3 meter long Komodo dragon.</p>
