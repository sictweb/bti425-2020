    ...
    return (
      <div className="container">
        ...
        <Switch>
          ...
          <Route exact path='/horse' render={() => (<Horse />)} />
          <Route exact path='/lizard' render={() => (<Lizard />)} />
          <Route exact path='/bear' render={() => (<Bear />)} />
          <Route exact path='/eagle' render={() => (<Eagle />)} />
          <Route exact path='/dolphin' render={() => (<Dolphin />)} />
